    ...
    <div className="main">
      <div className="header">
        ...
        <div className="dropdown">
          <span className="dropdown-span">Hello Rifaque </span>
      ...
      <div className="section">
        <div className="nav">
          <div className="profile">
            <img
              src="https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w=740&t=st=1694978049~exp=1694978649~hmac=e2b59807653860ac4e268280582e2f924b5f037df601375fd26ee826449fe5af"
              alt=""
            ></img>
